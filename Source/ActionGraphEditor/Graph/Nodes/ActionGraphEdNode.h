...
#include "ActionGraphEdNode.generated.h"
...
UCLASS()
class UActionGraphEdNode: public UEdGraphNode
{
	GENERATED_BODY()
...
public:
	...
	const UActionGraphNode* GetDebuggedNode() const;
