...
#include "ActionGraphPinInfoDetails.h"

#include "DetailLayoutBuilder.h"
#include "DetailWidgetRow.h"
#include "SPinTypeSelector.h"

#define LOCTEXT_NAMESPACE "HBActionGraphPinInfoDetails"

void FActionGraphPinInfoDetails::CustomizeHeader(TSharedRef<IPropertyHandle> InStructPropertyHandle, FDetailWidgetRow& InHeaderRow, IPropertyTypeCustomizationUtils& InStructCustomizationUtils)
{
	...
	NamePropertyHandle = InStructPropertyHandle->GetChildHandle(GET_MEMBER_NAME_CHECKED(FHBActionGraphPinInfo, Name));
	TypePropertyHandle = InStructPropertyHandle->GetChildHandle(GET_MEMBER_NAME_CHECKED(FHBActionGraphPinInfo, Type));
	...
	[
		...
		[
			...
			[
				...
				.OnTextChanged(this, &FActionGraphPinInfoDetails::HandleTextChanged)
				.OnTextCommitted(this, &FActionGraphPinInfoDetails::HandleTextCommitted)
			]
		]
	]
	.ValueContent()
	...
	[
		...
		[
			...
			.TargetPinType(this, &FActionGraphPinInfoDetails::GetTargetPinType)
			.OnPinTypeChanged(this, &FActionGraphPinInfoDetails::HandlePinTypeChanged)
			.Schema(K2Schema)
...
FEdGraphPinType FActionGraphPinInfoDetails::GetTargetPinType() const
{
...
void FActionGraphPinInfoDetails::HandlePinTypeChanged(const FEdGraphPinType& InPinType)
{
	void* ValuePtr = nullptr;
	if(TypePropertyHandle->GetValueData(ValuePtr) != FPropertyAccess::Fail)
	{
...
bool FActionGraphPinInfoDetails::IsNameValid(const FString& InNewName)
{
...
void FActionGraphPinInfoDetails::HandleTextChanged(const FText& InNewText)
{
...
void FActionGraphPinInfoDetails::HandleTextCommitted(const FText& InNewText, ETextCommit::Type InCommitType)
{
	const FString NewTextAsString = InNewText.ToString();
	if(IsNameValid(NewTextAsString))
	{
