...
struct FHBCharacterEditorModes
{
	// Mode constants
	static const FName HBCombatEditorMode;
	static const FName HBThumbnailEditorMode;
	...
	static FText GetLocalizedMode(const FName InMode)
	{
		...
		if (LocModes.Num() == 0)
		{
			...
			LocModes.Add(HBThumbnailEditorMode,
			             NSLOCTEXT("HBThumbnailEditorMode", "HBThumbnailEditorMode", "Thumbnail"));
		}
...
private:
	FHBCharacterEditorModes()
	{
	}
};


class FActionGraphEditor : public IActionGraphEditor, public FGCObject, public FNotifyHook
{
public:
	FActionGraphEditor();
	~FActionGraphEditor();
	...
	static const FName ActionGraphTabID;
