...
class ACTIONGRAPHEDITOR_API SHBGraphNodeAction : public SGraphNode
{
public:
	...
	void Construct(const FArguments& InArgs, UActionGraphEdNode* InNode);
...
protected:
	UActionGraphEdNode* CachedGraphNode = nullptr;
