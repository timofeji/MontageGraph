...
#include "SHBActionGraphNodeRow.h"
...
void SHBActionGraphNodeRow::Construct(const FArguments& InArgs, UActionGraphNode* InRuntimeNode)
{
	check(InRuntimeNode);
	...
	[
		...
		[
			...
			[
				...
				.Font(FontStyle)
				.Text(this, &SHBActionGraphNodeRow::GetValueText)
...
FText SHBActionGraphNodeRow::GetValueText() const
{
