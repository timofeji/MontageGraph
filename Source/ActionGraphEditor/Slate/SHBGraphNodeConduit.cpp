...
#include "SGraphPin.h"
#include "Graph/Nodes/HBActionGraphEdNodeConduit.h"
#include "SHBActionGraphConduitOutputPin.h"
#include "Widgets/Layout/SScaleBox.h"

#define LOCTEXT_NAMESPACE "SHBActionGraphNodeConduit"

void SHBGraphNodeConduit::Construct(const FArguments& InArgs, UActionGraphEdNodeConduit* InNode)
{
	GraphNode = InNode;
...
void SHBGraphNodeConduit::RefreshOutputPins()
{
	...
	UActionGraphEdNodeConduit* StateNode = CastChecked<UActionGraphEdNodeConduit>(GraphNode);
...
void SHBGraphNodeConduit::UpdateGraphNode()
{
	...
	[
		SNew(SBorder)
		.BorderImage(FActionGraphEditorStyles::Get().GetBrush("HBEditor.ActionGraph.Node.BackgroundLight"))
		...
		[
			...
			// 			.BackgroundColor(this, &SHBActionGraphNodeConduit::GetErrorColor)
			// 			.ToolTipText(this, &SHBActionGraphNodeConduit::GetErrorMsgToolTip)
			// 		]
			// 	]
			// ]
...
void SHBGraphNodeConduit::CreatePinWidgets()
{
	...
	UActionGraphEdNode* StateNode = CastChecked<UActionGraphEdNode>(CachedGraphNode);
	...
	for (int32 PinIdx = 0; PinIdx < StateNode->Pins.Num(); PinIdx++)
	{
		...
		{
			TSharedPtr<SGraphPin> NewPin = SNew(SHBActionGraphConduitOutputPin, MyPin);
...
TSharedPtr<SToolTip> SHBGraphNodeConduit::GetComplexTooltip()
{
	...
	[
		...
		// 	.CornerOverlayText(this, &SHBActionGraphNodeConduit::GetPreviewCornerText)
