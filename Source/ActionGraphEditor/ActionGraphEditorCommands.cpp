...
#define LOCTEXT_NAMESPACE "HBActionGraphBlueprintEditorCommands"

FActionGraphEditorCommands::FActionGraphEditorCommands() : TCommands<
	FActionGraphEditorCommands>(
	"ACEBlueprintEditorCommands",
	NSLOCTEXT("Contexts", "ACEBlueprintEditorCommands", "HBAction Graph Editor"),
	NAME_None,
	FAppStyle::GetAppStyleSetName())
{
}

void FActionGraphEditorCommands::RegisterCommands()
{
