...
FMontageGraphEditorCommands::FMontageGraphEditorCommands() : TCommands<
	...
	"MontageGraphBlueprintEditorCommands",
	NSLOCTEXT("Contexts", "MontageBlueprintEditorCommands", "Montage Graph Editor"),
	NAME_None,
...
void FMontageGraphEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(EditNodeBlends, "Edit Node Blends", "Edit/Add Node edge Blends",
	           EUserInterfaceActionType::Button, FInputChord());
}
