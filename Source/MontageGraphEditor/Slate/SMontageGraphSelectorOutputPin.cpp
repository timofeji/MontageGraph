...
#include "MontageGraphEditor/MontageGraphEditorStyle.h"
...
{
	const ISlateStyle& Style = FMontageGraphEditorStyle::Get();
...
const FSlateBrush* SMontageGraphSelectorOutputPin::GetPinBorder() const
{
	...
	return FMontageGraphEditorStyle::Get().GetBrush(FName(*StyleName));
}
