...
public:
	...
	void MapGraph(UMontageGraph* MontageGraph);
	...
	UAnimMontage*			RebuildMontageForMontageNode(UMontageGraph* OwningGraph, UMGEdNode* Node);
	...
	void RebuildNodeTree(UMGEdNode* RootNode, UMontageGraph* OwningGraph, TArray<UMGEdNode_Montage*>& MontageNodes);
