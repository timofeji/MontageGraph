...
private:
	...
	void CreateEdgeConnection(UEdGraphPin* PinA, UEdGraphPin* PinB, const UMGEdNode* OwningNodeA, const UMGEdNode* OwningNodeB) const;
	void CreateAndAddActionToContextMenu(FGraphContextMenuBuilder& ContextMenuBuilder, TSubclassOf<UMGNode> NodeType) const;
